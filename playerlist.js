const playerList = [
	...
	['Cham', 'FSL_Cham.mp4', 'Cham.wav'],
	['Chatomic', 'FSL_Chatomic.mp4', 'FSL_Chatomic.wav'],
	['CheesyNachos', 'cheesy_nachos.mp4', 'cheesy_nachos.wav', 'noTitle'],
	['ChienPwn', 'ChienPwn2.mp4', 'ChienPwn.wav'],
	...
	['ForJumy', 'ForJumy.mp4', ''],
	['Gerald', 'FSL_Gerald.mp4', 'Gerald.wav'],
	['GG', 'transparent_greenscreen.mp4', 'FSL_GG.mp3', 'noTitle'],
	['GG_Izzy', 'GG_Izzy.mp4', 'gg_izzy.wav'],
	['GreatArchon', 'FSL_GreatArchon.mp4', 'FSL_GreatArchon.wav'],
	['Greempire', 'greempire.mp4', 'greempire.wav'],
	['Haak3r', 'FSL_Haak3r.mp4', 'FSL_Haak3r.wav'],
	...
	['Klem', 'FSL_Klem.mp4', 'FSL_Klem.wav'],
	['Kriminal', 'Kriminal_FSL.mp4', 'Kriminal.wav'],
	['LanixMagi', 'FSL_LanixMagi.mp4', 'FSL_LanixMagi.wav'],
	...
	['ManShark', 'FSL_ManShark.mp4', 'FSL_ManShark.wav'],
	['MaxPax', 'FSL_MaxPax.mp4', 'MaxPax.wav'],
	['MedicJr', 'FSL_MedicJr.mp4', 'FSL_MedicJr.wav'],
	['MemesDreams', 'MemesDreams.mp4', 'MemesDreams.wav'],
	['Meomaika2', 'Meomaika2.mp4', ''],
	['Migu3la', 'migu3la_2023_final.mp4', 'migu3la.wav'],
	['MonkeyShaman', 'MonkeyShaman_intro.mp4', 'monkeyshaman.wav'],
	['MrLasti', 'PSL_MrLasti.mp4', 'freeden.wav'],
	['MrsUberXL', 'mrsuberxl.mp4', 'mrsuberxl.wav'],
	['MvonLipwig', 'FSL_MvonLipwig.mp4', 'FSL_MvonLipwig.wav'],
	['Nachoz', 'FSL_Nachoz_s9.mp4', 'Nachoz.wav'],
	['Nate', 'FSL_Nate.mp4', 'FSL_Nate.wav'],
	['NeO', 'NeO.mp4', ''],
	['Neutrophil', 'edmund_IMG_2967.mp4', 'neutrophil.wav'],
	['Nightmare', 'PSL_Nightmare.mp4', ''],
	['NizmoFlarem', 'NizmoFlarem.mp4', 'NizmoFlarem.wav'],
	['Nooblord', 'nooblord.mp4', 'nooblord.wav'],
	['Nuke', 'FSL_Nuke.mp4', 'Nuke.wav'],
	['NukLeo', 'FSL_NukLeo.mp4', 'FSL_NukLeo.wav'],
	['Nuks2', 'PSL_Nuks2.mp4', 'db.wav'],
	['Pangz', 'PSL_Pangz.mp4', 'cloak.wav'],
	['PanicSwitch', 'PanicSwitch.mp4', 'PanicSwitch.wav'],
	['Parkanian', 'FSL_Parkanian.mp4', 'parkanian.wav'],
	...
	['PossiblyMayB', 'FSL_PossiblyMayB.mp4', 'FSL_PossiblyMayB.wav'],
	...
	['SCVSir', 'FSL_SCVSir.mp4', 'FSL_SCVSir.wav'],
	['SEMPER', 'PSL_SEMPER.mp4', 'sef.wav'],
	['Sef', 'sef.mp4', 'sef.wav'],
	['Sequoia', 'FSL_Sequioa_intro.mp4', 'sequoia.wav'],
	['Serral', 'FSL_Serral.mp4', 'Serral.wav'],
	['SgtABC', 'FSL_SgtABC.mp4', 'SgtABC.wav'],
	['ShadeHealer', 'FSL_ShadeHealer.mp4', 'FSL_ShadeHealer.wav'],
	['Shadow', 'PSL_Shadow.mp4', ''],
	['SirMalagant', 'sirmalagant.mp4', 'sirmalagant.wav'],
	['Soil', 'FSL_Soil.mp4', 'FSL_Soil.wav'],
	['Sopuli', 'FSL_Sopuli.mp4', 'FSL_Sopuli.wav'],
	['sOs', 'FSL_sOs.mp4', 'FSL_sOs.wav'],
	['SouLeer', 'PSL_SouLeer.mp4', ''],
	['SpeCial', 'PSL_SpeCial.mp4', ''],
	['Spirit', 'FSL_Spirit.mp4', 'Spirit.wav'],
	['Staged', 'FSL_Staged.mp4', 'FSL_Staged.wav'],
	...
	['WindShadow', 'FSL_WindShadow.mp4', 'FSL_WindShadow.wav'],
